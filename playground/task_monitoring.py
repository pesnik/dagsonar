...
class DAGChangeNotifier:
    def __init__(self, config_path: str = 'dag_monitor_config.json'):
        """
        Initialize the DAG change notifier with configuration
        ...
        self.monitored_tasks = self.config.get('monitored_tasks', {})
    ...
    def _create_default_config(self) -> dict:
        ...
        default_config = {
            ...
            "email_config": {
                ...
                "smtp_port": 587,
                "sender_email": "itappsupportdatawarehouse@banglalink.net",
                "recipients": [
                    "itappsupportdatawarehouse@banglalink.net"
                ]
            }
        }
...
def main():
    ...
    dag_file_path = os.environ.get('DAG_FILE_PATH', 'finance_month_closing_automation.py')
